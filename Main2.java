...
class China extends wonders7 {
    ...
    void famousfor() {
        System.out.println("It is Famous for The Great Wall\n");
    }
}
...
class TajMahal extends wonders7 {
    ...
    void famousfor() {
        System.out.println("It is Famous for its stunning white marble mausoleum\n");
    }
}
...
class Redeemer extends wonders7 {
    ...
    void famousfor() {
        System.out.println("It is Famous for it is 30 meters tall\n");
    }
}
